...
const Footer = () => {
  ...
  return (
    <footer className="mt-188px w-full bg-black border-t border-gray-800">
      <div className="max-w-7xl mx-auto px-4 py-5">
        <div className="flex justify-between items-start">
          {/* Left side */}
          <div>
            <div className="text-gray-400 text-xs mb-4 pt-1 pb-1 pl-3 pr-3 bg-gray-900 border border-gray-800 max-w-[190px]">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="relative inline-flex items-center group">
                <button className="flex items-center gap-2 px-4 py-2 rounded-md border border-gray-800 text-gray-300 hover:bg-gray-800 hover:text-white transition-colors text-xs">
          ...
          <div className="flex flex-col items-end gap-4">
            ...
            <div className="flex items-center gap-2 pt-8">
              ...
              <div className="flex items-center">
                <Image
                  ...
                  width={20}
                  height={20}  // Make sure to add the image to your public/images folder
                />
            ...
            <div className="flex items-center">
              ...
              <div className="flex items-center gap-3 pt-4">
                <Link href="https://discord.com/invite/vbVMUwXWgc" className="text-gray-400 hover:text-white transition-colors">
                ...
                <Link href="https://twitter.com/0xmetaschool" className="text-gray-400 hover:text-white transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                  </svg>
                </Link>
                <Link href="https://www.linkedin.com/company/0xmetaschool/" className="text-gray-400 hover:text-white transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
